        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                for (const memo of memos) {
                    const filePath = `${outputPath}/${(0, sanitize_filename_ts_1.sanitize)(memo.id + '_' + memo.title)}.pdf`;
                    ...
                    try {
                        const mkFilePath = `${outputPath}/${(0, sanitize_filename_ts_1.sanitize)(memo.id + '_' + memo.title)}.md`;
